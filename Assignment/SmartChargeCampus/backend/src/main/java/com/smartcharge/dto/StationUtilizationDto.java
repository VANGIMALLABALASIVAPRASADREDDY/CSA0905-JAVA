...
public class StationUtilizationDto {
    ...
    public StationUtilizationDto(int stationId, String stationName, String campusLocation, 
                                 double maximumLoadKw, int totalPoints, int activePoints, 
                                 int totalSessions, double totalEnergyKwh, double totalRevenue, 
