...
public class CandidateScoreDto {
    ...
    private double availabilityScore; // 30
    private double waitTimeScore; // 25
    private double loadEfficiencyScore; // 20
    private double locationScore; // 15
    private double departureScore; // 10
